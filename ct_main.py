...
from ct_constants import CONFIG_PATH, MAPPINGS_PATH, SOLENOID_MUX_ADDR, SOLENOID_ON_TIME, LED_MUX_ADDR, CT_BUTTON_GPIO_PIN, POLLING_INTERVAL, MAJOR_ARP
...
class CT:
    ...
    def load_mappings(self, path, mapping) -> (dict, dict):
